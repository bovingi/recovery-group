...
writeRaster(crop_raster,filename = file.path(path_saveto, "nlcd_rast_cropped.tif"), overwrite=TRUE)

### write out shp of raster values extracted to points
st_write(extract_raster, file.path(path_saveto, "nlcd_rast_points.shp"), append = FALSE)
```
